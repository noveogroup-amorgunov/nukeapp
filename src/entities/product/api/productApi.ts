...
export const productApi = generatedApi.enhanceEndpoints<
  never,
  {
    getProducts: QueryDefinition<GetProductsApiArg, AppBaseQuery, ApiTagTypes, Product[], 'api'>
    getPopularProducts: QueryDefinition<GetPopularProductsApiArg, AppBaseQuery, ApiTagTypes, Product[], 'api'>
  }
>({
  endpoints: {
    getProducts: {
...
export const { useGetProductsQuery, useGetPopularProductsQuery } = productApi
