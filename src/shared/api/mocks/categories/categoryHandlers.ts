...
import type { CategoryWithProducts } from '@/shared/api'
...
export const categoriesHandlers = [
  http.get('/categories/popular', async () => {
  ...
  http.get('/categories/:id', async ({ request, params }) => {
    const { id } = params
    ...
    const categoryDto: CategoryWithProducts = {
      ...maybeCategory,
      products: [],
    }
